...
export const uploadMedia = async (media: Partial<Media>) => {
...
export const deleteMedia = async (media: Partial<Media>) => {
  const supabase = await createClient();
...
export const upsertMedia = async (media: Partial<Media>) => {
  const supabase = await createClient();
